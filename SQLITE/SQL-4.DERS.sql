...
Sorguda ArtistId, Name, Title ve AlbumId olmalıdır */
	...
	====================================================*/
		...
		FROM tracks t
		JOIN albums a
		on t.AlbumId = a.AlbumId AND Title = 'Faceless';
	...
	INSERT INTO vacation_plan VALUES(12, 'TR', 'comfort hotel', 3, 4, 3000);
...
INSERT INTO vacation_plan (place_id, country, hotel_name, employee_id) VALUES(35, 'TR', 'izmir hotel', 6);
   ...
   -- DEFAULT - Herhangi bir değer atanmadığında Başlangıç değerinin atanmasını sağlar.
	...
	/*vacation_plan tablosunu place_id sutunu PK ve employee_id sutununu ise 
	FK olarak  değiştirirek
	vacation_plan2 adinda yeni bir tablo oluşturunuz.
	...
	INSERT INTO vacation_plan2 VALUES(4,42,'TR','mevlana HOTEL',1,5,5660);	
